...
| Passing RC implementation and release-tooling checkpoint | `4a89b9a88c3dd6cde1c97e945fdbf37b8865e56c` (`1.0.0-rc.1`); the exact candidate is the later protected-`main` descendant dispatched to `release.yml` |
