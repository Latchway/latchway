...
| Latest passing core implementation | `3fcc0400cc9da7def1a6ad0d54718d7f5b62674e` |
...
| --- | --- | --- | --- | --- |
| Server and CLI | `github.com/latchway/latchway` | Latest local authenticated mixed-quota/configured-pricing/concurrency/token-bucket proxy and read-only quota-snapshot evidence for supported context-stable logical-request/output-token plans, plus full PostgreSQL-enabled normal/race, vet, contracts, policy fuzzing, focused snapshot PostgreSQL/authenticated E2E normal/race runs, reproducible unchanged bundle, zero `api`/migration diff, and clean P0-P2 review at `3fcc0400cc9da7def1a6ad0d54718d7f5b62674e`; earlier `make check` and local non-root OCI evidence at `0a03d9369c0ebcf793f00bac6b002d1caaea6b8e` | Source of truth | Remaining quota work, hard cost limits, upstream-reported pricing/retries, native attestation, live canary/SDK conformance, operations, current Compose/registry image proof, and release gates |
