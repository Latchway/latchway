...
| Latest passing core implementation | `a5a33f6358871c5e66113425ffcd4f3e8f2291d7` |
...
| --- | --- | --- | --- | --- |
| Server and CLI | `github.com/latchway/latchway` | Latest local authenticated mixed-quota proxy evidence plus full PostgreSQL-enabled normal/race, vet, contracts, changed fuzz-smoke, reproducible-bundle, and zero-public-schema-diff gates at `a5a33f6358871c5e66113425ffcd4f3e8f2291d7`; earlier `make check` and local non-root OCI evidence at `0a03d9369c0ebcf793f00bac6b002d1caaea6b8e` | Source of truth | Pricing attribution, concurrency/token-bucket and remaining quota work, native attestation, live canary/SDK conformance, operations, current Compose/registry image proof, and release gates |
