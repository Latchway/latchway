...
| Latest passing core implementation | `b2fdfe330175ea8c023ce2af6d8693437010b348` |
| Synchronized bundle baseline core | `68fa1ba28a80cd3fb1e50dffdefc7de935da9f4c` |
...
| --- | --- | --- | --- | --- |
| Server and CLI | `github.com/latchway/latchway` | Latest local authenticated mixed-quota/configured-pricing/concurrency/token-bucket/hard-calendar-cost proxy, read-only quota snapshots, and bounded user overrides, plus full PostgreSQL-enabled normal/race, vet, contracts, eight fuzz targets, focused override authorization/configuration/quota/Admin/CLI proof, the established authenticated Chat E2E remaining green, reproducible `0.2.0` bundle, and clean P0-P2 review at `b2fdfe330175ea8c023ce2af6d8693437010b348`; earlier `make check` and local non-root OCI evidence at `0a03d9369c0ebcf793f00bac6b002d1caaea6b8e` | Source of truth | Remaining quota work, input/total-token limits, other/input-priced cost shapes, upstream-reported pricing/retries, native attestation, live canary/SDK conformance, operations, current Compose/registry image proof, and release gates |
