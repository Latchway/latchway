...
| Latest passing core implementation | `58e8373bdb552496e6bb4c420832e5bb341dd4b3` |
...
| --- | --- | --- | --- | --- |
| Server and CLI | `github.com/latchway/latchway` | Latest local authenticated mixed-quota/configured-pricing proxy evidence plus full PostgreSQL-enabled normal/race, vet, contracts, four relevant fuzz smokes, PostgreSQL E2E count-3/race, reproducible unchanged bundle, and zero `api`/migration-diff gates at `58e8373bdb552496e6bb4c420832e5bb341dd4b3`; earlier `make check` and local non-root OCI evidence at `0a03d9369c0ebcf793f00bac6b002d1caaea6b8e` | Source of truth | Concurrency/token-bucket and remaining quota work, hard cost limits, upstream-reported pricing/retries, native attestation, live canary/SDK conformance, operations, current Compose/registry image proof, and release gates |
