...
| React Native | `@latchway/react-native@1.0.0`; source `81cac33cc6f11fff66fe1fde97ccfce439943df0` | Local JavaScript, synchronized exact native pins, bridge, New Architecture examples, package, and evidence-export gates pass; npm and physical-device proof not claimed |
...
| React Native | 33 Vitest, 21 Node, and the device-finalization/export/gateway suites plus lint, typecheck, codegen, build, New Architecture examples, native consumers, podspec, package closure, and reproducibility; current tarball at `81cac33cc6f11fff66fe1fde97ccfce439943df0` has SHA-256 `719830d3289ece5b677cd88417e0516a0bbbfe75a5e93b6204d8888f0d50379d` |
