...
| React Native | `@latchway/react-native@1.0.0`; source `04769b9b3b61e9341e3bf83145cf626e827078c8` | Local JavaScript, synchronized exact native pins, bridge, New Architecture examples, package, and evidence-export gates pass; npm and physical-device proof not claimed |
...
| React Native | 33 Vitest, 23 Node, and the device-finalization/export/gateway suites plus lint, typecheck, codegen, build, New Architecture examples, native consumers, podspec, package closure, and reproducibility; current tarball at `04769b9b3b61e9341e3bf83145cf626e827078c8` has SHA-256 `c1959f58ea8aca939c371bc20c20909c5f754e86d7ff4507307b0471054d5749` |
