...
| React Native | `@latchway/react-native@1.0.0`; source `3e80e47302773d209b98f51b4bedd412213e1605` | Local JavaScript, synchronized exact native pins, bridge, New Architecture examples, package, and evidence-export gates pass; npm and physical-device proof not claimed |
...
| React Native | 33 Vitest, 23 Node, and the device-finalization/export/gateway suites plus lint, typecheck, codegen, build, New Architecture examples, native consumers, podspec, package closure, and reproducibility; current tarball at `3e80e47302773d209b98f51b4bedd412213e1605` has SHA-256 `2b067b3fd147d31e61c25abbfbb2f9310bce63b035d885fb01753c1de8bce017` |
