<Info>
  Generated from working-tree source `packages/langchain/src/index.ts:L1-L103` for release candidate `v1.0.0` and recorded commit `b0069e993967662f4ee2729dbc393595793c5e50`. The dirty bundle does not claim that this region is already at that commit. Bundle SHA-256: `986b46c48abb3bcdef707b91ef01706d6f83ab1426c2be357a67b6f1d905b70c`.
</Info>
