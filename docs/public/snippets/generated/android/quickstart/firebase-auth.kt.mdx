<Info>
  Generated from working-tree source `sample-firebase/src/main/kotlin/dev/latchway/sample/firebase/MainActivity.kt:L1-L29` for release candidate `v1.0.0` and recorded commit `c05a74e735da3589f907eb0a788a2970245c0cc8`. The dirty bundle does not claim that this region is already at that commit. Bundle SHA-256: `bde9d735ce8de0522560a8756159a8fcbdff80029afdefa391f06753d6c2c2b1`.
</Info>
