<Info>
  Generated from working-tree source `Sources/LatchwayFoundationModels/LatchwayFoundationModels.swift:L28-L189` for release candidate `v1.0.0` and recorded commit `0074f532d639b83c27966f8c75ffe37ed8df6cc8`. The dirty bundle does not claim that this region is already at that commit. Bundle SHA-256: `c8303f1eb5d5f4b15f7a55ea7a6613148b63156850ea55fd08e1a41b8be6e018`.
</Info>
