...
| Release | `v1.0.0` |
| Commit | `11bfaef12f373a8a81e0b08a0f2ef0ef313e13dc` |
...
Working-tree source: `example/src/framework-consumers.ts:L31-L126`. The bundle records candidate commit `11bfaef12f373a8a81e0b08a0f2ef0ef313e13dc`, but does not claim that this dirty source region is already present at that commit.
...
Working-tree source: `example/src/App.tsx:L50-L74`. The bundle records candidate commit `11bfaef12f373a8a81e0b08a0f2ef0ef313e13dc`, but does not claim that this dirty source region is already present at that commit.
...
Working-tree source: `example/src/App.tsx:L87-L113`. The bundle records candidate commit `11bfaef12f373a8a81e0b08a0f2ef0ef313e13dc`, but does not claim that this dirty source region is already present at that commit.
