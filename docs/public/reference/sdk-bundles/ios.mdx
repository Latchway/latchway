...
| Package | `Latchway` |
| Release | `v1.0.0` |
| Commit | `0074f532d639b83c27966f8c75ffe37ed8df6cc8` |
...
Working-tree source: `Sources/LatchwayFoundationModels/LatchwayFoundationModels.swift:L28-L189`. The bundle records candidate commit `0074f532d639b83c27966f8c75ffe37ed8df6cc8`, but does not claim that this dirty source region is already present at that commit.
...
Working-tree source: `Sources/LatchwaySwiftOpenAI/LatchwaySwiftOpenAIHTTPClient.swift:L11-L99`. The bundle records candidate commit `0074f532d639b83c27966f8c75ffe37ed8df6cc8`, but does not claim that this dirty source region is already present at that commit.
...
Working-tree source: `Examples/AppExtensionComponents/Host/ComponentHostApp.swift:L37-L89`. The bundle records candidate commit `0074f532d639b83c27966f8c75ffe37ed8df6cc8`, but does not claim that this dirty source region is already present at that commit.
...
Working-tree source: `Examples/BasicURLSession/BasicURLSession.swift:L1-L34`. The bundle records candidate commit `0074f532d639b83c27966f8c75ffe37ed8df6cc8`, but does not claim that this dirty source region is already present at that commit.
