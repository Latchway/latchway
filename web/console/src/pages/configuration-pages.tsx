...
export function SetupWizardPage() {
  ...
  async function createWorkspace(event: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    try {
      ...
      const environment = (await adminRequest(`/admin/v1/applications/${application.id}/environments`, EnvironmentSchema, { method: "POST", body: { slug: environmentSlug, display_name: String(form.get("environment_name")), kind: environmentKind } })).data;
