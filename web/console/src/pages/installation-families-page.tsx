...
export function InstallationFamiliesPage() {
  ...
  async function revokeComponent(reason: string): Promise<void> {
    if (!canRevoke || !family || !component) return;
    setBusy(true); setProblem(undefined);
    try {
