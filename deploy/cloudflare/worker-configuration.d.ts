/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fdaf51853567e45349d8f4720061fb48)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	LATCHWAY_CONTAINER_INSTANCES: "4";
	LATCHWAY_ROLE: "all";
	...
	LATCHWAY_DATABASE_URL: string;
	LATCHWAY_MASTER_KEY: string;
	LATCHWAY_PUBLIC_ORIGIN: string;
	LATCHWAY_ADMIN_BOOTSTRAP_TOKEN: string;
	LATCHWAY_CONTAINER: DurableObjectNamespace<import("./src/index").LatchwayContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LatchwayContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LATCHWAY_CONTAINER_INSTANCES" | "LATCHWAY_ROLE" | "LATCHWAY_LOG_LEVEL" | "LATCHWAY_MIGRATE_ON_START" | "LATCHWAY_DB_MAX_CONNECTIONS" | "LATCHWAY_DB_COMPLETION_CONNECTIONS" | "LATCHWAY_SHUTDOWN_TIMEOUT" | "LATCHWAY_DATABASE_URL" | "LATCHWAY_MASTER_KEY" | "LATCHWAY_PUBLIC_ORIGIN" | "LATCHWAY_ADMIN_BOOTSTRAP_TOKEN">> {}
}
